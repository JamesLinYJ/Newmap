...
export const sessionRecordSchema = z.object({
  ...
  latestWeatherDatasetId: z.string().nullable().default(null),
})
...
export type WeatherDatasetRecord = z.infer<typeof weatherDatasetRecordSchema>
export type WeatherJobRecord = z.infer<typeof weatherJobRecordSchema>
