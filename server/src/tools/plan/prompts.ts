...
// 独立改写而来。GeoForge 没有本地计划文件，计划正文通过 exit_plan_mode
...
不要用本工具询问“计划是否可以”，计划审批必须通过 exit_plan_mode。`
...
- 计划模式的本轮只能以 request_clarification 或 exit_plan_mode 结束。`
